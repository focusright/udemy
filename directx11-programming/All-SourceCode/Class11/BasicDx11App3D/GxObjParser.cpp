// GxObjParser.cpp : Implements the CGxObjParser class.
//
...
// Loads an OBJ-file
bool CGxObjParser::LoadFile(char* szFileName)
{
    // Open file
    FILE* fp = NULL;
    ...
    for (i = 0; i < (int)m_nVertexCount; i++) {
        ...
        if (vti < vtbufpos) {
            ...
            m_pVertex[i].tex0.y = vtbuf[vti * 2 + 1];
        }
